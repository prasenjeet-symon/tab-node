...
export default class AppwriteDatabase {
  ...
  public async fetchUserNotificationByTopic(
    userDocID: string,
    topic: MUserNotification.notificationTopic,
    prevCursor: MUserNotification.IUserNotification | undefined,
    limit: number
  ) {
  ...
  public async fetchPostedArticles(userDocID: string) {
