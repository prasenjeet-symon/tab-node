...
import { AWFunction, AppwriteCollection, ArticleBoostPoints, MArticle, MArticleDistribution, MArticleReader, MArticleTopicRelationship, MTopic, MUser, MUserActivity, MUserRelationSuggestion, MUserRelationship, UserBoostPoints, deserializeAppwriteData, serializeAppwriteData } from '@tabnode/utils';
import { produce } from 'immer';
import { Permission, Query, Role } from 'node-appwrite';

/** Increase boost point of the article */
export async function incDecBoostPointOfArticle(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
    try {
...
export async function increaseDecreaseBoostPointOfArticleDistribution(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
    const client = new AppwriteNodeJsClient(req);
    const database = client.database();
    const databaseID = client.databaseID();
...
export async function increaseBoostPointOfUser(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
...
export async function increaseDecreaseRelationshipStrengthOfAuthorAndUser(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
...
export async function suggestUserAuthorToFollow(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
    // database connection
    const client = new AppwriteNodeJsClient(req);
    const database = client.database();
    const databaseID = client.databaseID();
...
export async function IncreaseDecreaseRelatedTopicsBoostPoint(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
    // database connection
    const client = new AppwriteNodeJsClient(req);
    const database = client.database();
    const databaseID = client.databaseID();
...
export async function addNewActivityForUser(req: AWFunction.Req, aReader: MArticleReader.IArticleReader) {
    // database connection
    const client = new AppwriteNodeJsClient(req);
    const database = client.database();
    const databaseID = client.databaseID();
