import {
  ...
  UserBoostPoints,
  createArticleRelationSuggestion,
...
export async function createArticleDistribution(article: MArticle.IArticle) {
  if (!article) return;
...
export async function increaseBoostPointOfUser(article: MArticle.IArticle) {
...
export async function IncreaseDecreaseRelatedTopicsBoostPoint(article: MArticle.IArticle) {
  // database connection
  const client = new AppwriteNodeJsClient();
  const database = client.database();
  const databaseID = client.databaseID();
...
export async function addNotificationForAuthor(article: MArticle.IArticle) {
  // database connection
  const client = new AppwriteNodeJsClient();
  const database = client.database();
  const databaseID = client.databaseID();
...
export async function addNewActivityForUser(article: MArticle.IArticle) {
  // database connection
  const client = new AppwriteNodeJsClient();
  const database = client.database();
  const databaseID = client.databaseID();
