import { AppwriteCollection, AppwriteNodeJsClient, MArticleDistribution, MArticleRelationSuggestion, MTopic, createArticleRelationSuggestion, fetchAllUserRelatedToTopic, fetchFullTopic, getPhaseUsersPercentage, getThreshold, serializeAppwriteData } from '@tabnode/utils';
...
export async function createPhase(oldData: MArticleDistribution.IArticleDistribution, newData: MArticleDistribution.IArticleDistribution) {
